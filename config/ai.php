...
return [
    ...
    */
    ...
    // Storefront wiring: conversation titles are generated through the same
    // provider gateway as replies. In replay mode that turn has no recording,
    // so titles stay off — one less way replay could look like a live model.
    'conversations' => [
